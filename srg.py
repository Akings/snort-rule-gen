...
def download_vocab(model_dir='models', model_name='124M'):
    """Downloads the vocab model into the current directory
...
def finetune(sess,
    ...
    for file in ['hparams.json', 'encoder.json', 'vocab.bpe']:
        try:
            ...
            print("You need to download the vocab model first via download_vocab()")
            raise(fnf_error)
